  ...
  return (
    <nav className="bg-light shadow-md p-2 flex justify-between items-center">
      ...
      <div className="flex items-center  font-montserrat  space-x-4">
        <div className="w-8 h-8 hover:animate-pulse bg-textHover  transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-textHover cursor-pointer rounded-full flex items-center justify-center">
